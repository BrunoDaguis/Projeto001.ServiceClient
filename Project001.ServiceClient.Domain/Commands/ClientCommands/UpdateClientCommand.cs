...
namespace Project001.ServiceClient.Domain.Commands.ClientCommands
{
    public class UpdateClientCommand : Notifiable, ICommand
    {
        ...
        public UpdateClientCommand(int id, string name, DateTime birthDate, ETypeDocument typeDocument, string numberDocument)
        {
            Id = id;
            Name = name;
            BirthDate = birthDate;
        ...
        public void Validate()
        {
            AddNotifications(
              new Contract()
              .Requires()
              .AreNotEquals(Id, 0, "Id", "Nenhum cliente para alteração")
